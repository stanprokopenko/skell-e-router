...
- [ ] Derive `skell_e_router.__version__` from package metadata instead of a separate literal. Release 3.31.0 at `9f93abb` still reports 3.30.1 through that field; distribution metadata and Opus 5.5 code are correct. See [consumer verification](router-consumers-2026-09-22.md).
